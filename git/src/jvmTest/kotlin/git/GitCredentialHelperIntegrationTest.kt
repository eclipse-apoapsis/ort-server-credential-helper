...
/**
 * A Kotest condition class to limit the execution of the integration tests for Git to Linux hosts only. The tests
 * require the Linux binary of the integration helper for the creation of a test container image. This binary is only
 * built on Linux.
 * This class is derived from the Kotest documentation:
 * https://kotest.io/docs/framework/conditional/spec-annotations-conditional-evaluation.html#enabledif
 */
